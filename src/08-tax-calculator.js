...
export function calculateTax(income) {
  ...
  else if (income>10000 && income<=30000) return .1*(income-10000);
  else if (income>30000 && income<=70000) return 2000+.2*(income-30000);
  else if (income>70000) return 10000+.3*(income-70000);
